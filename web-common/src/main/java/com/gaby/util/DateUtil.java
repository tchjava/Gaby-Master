...
public class DateUtil {
     ...
     * @return
     */
    public static String getYearAndWeekOfYear(Date date) {
        LocalDate localDate = conversionDate2LocalDate(date);
        int week = localDate.get ( IsoFields.WEEK_OF_WEEK_BASED_YEAR );
        int weekYear = localDate.get ( IsoFields.WEEK_BASED_YEAR );
        return weekYear+String.format("%02d", week);
    }
    /**
